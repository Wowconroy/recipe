package com.example.assignment2.bootstrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<UnitOfMeasures> eachUomOptional = unitOfMeasuresRepository.findByDescription("Each");

        if (!eachUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasures> tableSpoonUomOptional = unitOfMeasuresRepository.findByDescription("Tablespoon");

        if (!tableSpoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasures> teaSpoonUomOptional = unitOfMeasuresRepository.findByDescription("Teaspoon");

        if (!teaSpoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasures> dashUomOptional = unitOfMeasuresRepository.findByDescription("Dash");

        if (!dashUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasures> pintUomOptional = unitOfMeasuresRepository.findByDescription("Pint");

        if (!pintUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasures> cupsUomOptional = unitOfMeasuresRepository.findByDescription("Cup");
        ...
        //get optionals
        UnitOfMeasures eachUom = eachUomOptional.get();
        UnitOfMeasures tableSpoonUom = tableSpoonUomOptional.get();
        UnitOfMeasures teaSpoonUom = tableSpoonUomOptional.get();
        UnitOfMeasures dashUom = dashUomOptional.get();
        UnitOfMeasures pintUom = pintUomOptional.get();
        UnitOfMeasures cupsUom = cupsUomOptional.get();
